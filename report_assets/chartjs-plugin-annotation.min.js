...
!(function (t, e) {
    ...
    const r = (function (t, o, n) {
      ...
      for (const e of n)
        e.scaleID === i
          ...
          : E(t, e, s) === i && rt(e, o, [r + 'Min', r + 'Max', r + 'Value'], a);
      return a;
    })(t.scales, o, n);
        ...
        (function (t, o) {
          ...
          const { separatorStart: c, separatorEnd: l } = (function (t, e) {
            ...
            { sideStart: h, sideEnd: u } = (function (t, e, o) {
              ...
              let c, l;
              'left' === e || 'right' === e
                ? ((c = { x: o.x, y: n + b(i, a) }), (l = { x: c.x + d, y: c.y }))
  ...
  const ct = (t, e, o) => ({ x: t.x + o * (e.x - t.x), y: t.y + o * (e.y - t.y) }),
    ...
    bt = (t, o, n, r) => -Math.atan2(pt(t.x, o.x, n.x, r), pt(t.y, o.y, n.y, r)) + 0.5 * e.PI;
  class gt extends t.Element {
    inRange(t, e, o, n) {
      ...
      if ('x' !== o && 'y' !== o) {
        ...
        return (
          (function (t, { mouseX: e, mouseY: o }, n = s, r) {
            const { x: i, y: a, x2: d, y2: c } = t.getProps(['x', 'y', 'x2', 'y2'], r),
              l = d - i,
              h = c - a,
              u = ut(l) + ut(h),
      ...
      return (function (t, { mouseX: e, mouseY: o }, n, { hBorderWidth: r, useFinalPosition: i }) {
        ...
        return (
          (s.value >= s.start - r && s.value <= s.end + r) || wt(t, { mouseX: e, mouseY: o }, i, n)
        );
    ...
    draw(t) {
        ...
        return (
          (function (t, o, n, r) {
            const { x: i, y: s, x2: a, y2: d, options: c } = o,
              { startOpts: l, endOpts: h, startAdjust: u, endAdjust: f } = St(o),
              x = { x: i, y: s },
              y = { x: a, y: d },
              p = bt(x, n, y, 0),
              b = bt(x, n, y, 1) - e.PI,
      ...
      const { startOpts: c, endOpts: l, startAdjust: h, endAdjust: u } = St(this),
    ...
    resolveElementProperties(t, o) {
      ...
      return (
        (l._visible = d),
        (c.elements = [
          { type: 'label', optionScope: 'label', properties: l, initProperties: c.initProperties },
        ]),
        c
      );
    }
  ...
  function Pt(t, e) {
    ...
    return o > r - n
      ? (r + n) / 2
      : (n >= t - i - s && (t = n + i + s), r <= t + i + s && (t = r - i - s), t);
  }
  function St(t) {
    const e = t.options,
  ...
  function kt(t, e, o, n) {
    ...
    const { length: r, width: i, fill: s, backgroundColor: a, borderColor: d } = n,
      c = Math.abs(e - r) + o;
    (t.beginPath(),
      j(t, n),
      A(t, n),
  ...
  class At extends t.Element {
    inRange(t, o, n, r) {
      ...
      const { x: d, y: c, x2: l, y2: h } = this.getProps(['x', 'y', 'x2', 'y2'], r),
        u = a / 2,
  ...
  class jt extends t.Element {
    inRange(t, e, o, n) {
      ...
      const l = c / 2,
        h = 'y' === o ? { start: i, end: a, value: e } : { start: r, end: s, value: t };
    ...
    draw(t) {
      ...
      (R(t, this, this.centerX, this.centerY),
        n && !k(e.pointStyle) && ((t.shadowColor = e.borderShadowColor), t.stroke()),
        t.restore(),
        (e.borderWidth = o));
    }
    resolveElementProperties(t, e) {
  ...
  function Wt(t = 'line') {
    return Tt[t]
      ? t
      : (console.warn(`Unknown annotation type: '${t}', defaulting to 'line'`), 'line');
  }
  function _t(o, n, r, i) {
