...
def main():
    ...
    if len(sys.argv) < 6:
        ...
        print("  --use-edit-suffix                Edit via .excalidraw.edit")
        print("                                  to avoid editor overwrite")
        print("                                  issues (enabled by default;")
        print("                                  use --no-use-edit-suffix")
        print("                                  to disable)")
        print("\nExamples:")
    ...
    try:
        ...
        if work_path is not None and final_path is not None and work_path.exists():
            try:
                finalize_edit_path(work_path, final_path)
            except OSError:
                pass
