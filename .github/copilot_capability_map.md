...
| `.github/instructions/terminal-python-env.instructions.md`        | `**/*.py,tests/**/*.py,release.py,regenerate_changelog.py`                                                               | Enforces shell + venv command patterns (Git Bash, PowerShell, WSL) |
...
| `.github/instructions/authoring.instructions.md`                  | `.github/instructions/*.instructions.md`                                                                                  | Standardizes instruction authoring quality and scope       |
