...
- Exports to `.beads/issues.jsonl` after changes (30s debounce)
- Imports from JSONL when newer (e.g., after `git pull`)
- Use `bd sync` to force immediate sync (bypasses debounce)
...
- ✅ Run `bd sync` after batch changes to force immediate sync
