...
Hook behavior installed:
    ...
    pre-push    - full quality gate via validate.py (~60-120s).  Runs on `git push`.
...
_BD_CALL_PRECOMMIT = """\
# Delegate to bd (beads) tool if installed.
if command -v bd >/dev/null 2>&1; then
    ...
    echo "[git-hook] bd not found; skipping beads tracking." >&2
    echo "[git-hook]   Windows: winget install beads  |  macOS: brew install beads" >&2
fi\
"""
