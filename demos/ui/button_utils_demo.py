"""
Button Utils Demo Application

This script demonstrates and validates the usage of the button_utils module.
To run this demo, execute: python demos/ui/button_utils_demo.py
"""
