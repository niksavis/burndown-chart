...
def create_dora_summary_chart(metrics_data: Dict[str, Dict[str, Any]]) -> go.Figure:
    ...
    metrics = ["Deployment<br>Frequency", "Lead Time for<br>Changes", 
               "Change Failure<br>Rate", "Mean Time to<br>Recovery"]
    
    scores = []
    for metric_key in ["deployment_frequency", "lead_time_for_changes", 
