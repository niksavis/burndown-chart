...
def create_save_query_modal():
    """
    Create modal for saving JQL query profiles.

    Returns:
        dbc.Modal: Modal for entering query name and description
    """
    return dbc.Modal(
        [
            dbc.ModalHeader(
                dbc.ModalTitle(
                    [html.I(className="fas fa-save me-2"), "Save JQL Query"]
                ),
                close_button=True,
            ),
            dbc.ModalBody(
                [
                    # Query Preview
                    html.H6("Query to Save:", className="mb-2"),
                    html.Div(
                    ...
                    # Query Name Input
                    html.Label("Query Name:", className="fw-bold mb-2"),
                    dbc.Input(
                        id="query-name-input",
                        type="text",
                        placeholder="e.g., Sprint 23 Completed Items",
                        className="mb-2",
                    ),
                    html.Div(
                    ...
                    html.Label("Description (Optional):", className="fw-bold mb-2"),
                    dbc.Textarea(
...
def create_delete_query_modal():
    """
    Create modal for confirming JQL query deletion.

    Returns:
        dbc.Modal: Modal for confirming query deletion
    """
    return dbc.Modal(
        [
            dbc.ModalHeader(
                dbc.ModalTitle(
                    [html.I(className="fas fa-trash me-2"), "Delete JQL Query"]
                ),
                close_button=True,
            ),
            dbc.ModalBody(
                [
                    ...
                    html.Div(
                        [
                            html.Strong("Query: ", className="me-2"),
                            html.Span(id="delete-query-name", className="text-primary"),
                        ],
...
def create_edit_query_modal():
    """
    Create modal for editing existing JQL query profiles.

    Returns:
        dbc.Modal: Modal for editing query details
    """
    return dbc.Modal(
        [
            dbc.ModalHeader(
                dbc.ModalTitle(
                    [html.I(className="fas fa-edit me-2"), "Edit JQL Query"]
                ),
                close_button=True,
            ),
            dbc.ModalBody(
                [
                    ...
                    # JQL Input
                    html.Label("JQL Query:", className="fw-bold mb-2"),
                    dbc.Textarea(
            ...
            dbc.ModalFooter(
                [
                    ...
                    dbc.Button(
                        [html.I(className="fas fa-save me-2"), "Update Query"],
